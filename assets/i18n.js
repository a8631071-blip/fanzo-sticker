(function () {
  ...
  const EXACT_DYNAMIC = new Map([
    ['煩躁胖子', 'Fanzo'],
    ['｜貼圖工作站', ' | Sticker Workshop'],
    ['本工具免費提供使用，原始碼同步公開於', 'These tools are free to use. The source code is available on'],
    ['，採 MIT License 授權。', ' under the MIT License.'],
    ['素材拼板', 'Collage Board'],
    ['工程日誌：2026-07-24 建立 0724V3，新增整面背景圖大膽版、背景圖濃度控制與定位角保護重畫。', 'Engineering log: 2026-07-24 created 0724V3 with full-image bold mode, background-image strength control, and protected finder-pattern redraw.'],
    ['LINE主題', 'LINE themes'],
    ['· 點擊每張貼圖下方的', '· Click the'],
    ['· 點擊', '· Click'],
    ['・免費公開版工具', ' · Free Public Tools'],
    ['共', 'Total'],
    ['成功 48×48', 'Ready 48×48'],
    ['成功 96×96', 'Ready 96×96'],
    ['更新日期 2026/07/11', 'Updated 2026/07/11'],
    ['格 · 每格約', 'cells · approx.'],
    ['設定封面圖', 'button below each sticker to set the cover image'],
    ['設定標籤圖', 'to set the tab image'],
    ['選擇圖片', 'Choose image'],
    ['已清空。', 'Cleared.'],
